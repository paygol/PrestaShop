...
- Opcion 1: subir el archivo via FTP, descomprimir el contenido del archivo "paygol_prestashop_v1.1.zip" directamente en la carpeta "modules/" de tu sitio prestashop.
...
- ID de tu servicio de Paygol. (este número lo encuentras en "Mis Servicios" en tu cuenta de Paygol).
- Secret key de tu servicio de Paygol. (este número lo encuentras en "Mis Servicios" en tu cuenta de Paygol).
